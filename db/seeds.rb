...
Submission.create(id: 1, user_id: 35653, created_at: "2017-07-20T10:29:01.400+03:00",
...
Point.create(exercise_id: 4, point_id: 15, course_id: 1, user_id: 2, submission_id: 13, name: "08-04.3")

Point.create(exercise_id: 5, point_id: 16, course_id: 1, user_id: 2, submission_id: 14, name: "08-05")
...
Point.create(exercise_id: 7, point_id: 21, course_id: 1, user_id: 2, submission_id: 17, name: "08-07.2")

Point.create(exercise_id: 7, point_id: 22, course_id: 1, user_id: 2, submission_id: 17, name: "08-07.3")

Point.create(exercise_id: 7, point_id: 23, course_id: 1, user_id: 2, submission_id: 17, name: "08-07.4")

Point.create(exercise_id: 8, point_id: 24, course_id: 1, user_id: 2, submission_id: 18, name: "08-08.1")

Point.create(exercise_id: 8, point_id: 25, course_id: 1, user_id: 2, submission_id: 19, name: "08-08.2")

Point.create(exercise_id: 8, point_id: 26, course_id: 1, user_id: 2, submission_id: 20, name: "08-08.3")
...
Point.create(exercise_id: 4, point_id: 14, course_id: 1, user_id: 3, submission_id: 12, name: "08-04.2")

Point.create(exercise_id: 4, point_id: 15, course_id: 1, user_id: 3, submission_id: 13, name: "08-04.3")

Point.create(exercise_id: 5, point_id: 16, course_id: 1, user_id: 3, submission_id: 14, name: "08-05")

Point.create(exercise_id: 6, point_id: 17, course_id: 1, user_id: 3, submission_id: 15, name: "08-06.1")

Point.create(exercise_id: 6, point_id: 18, course_id: 1, user_id: 3, submission_id: 15, name: "08-06.2")

Point.create(exercise_id: 6, point_id: 19, course_id: 1, user_id: 3, submission_id: 15, name: "08-06.3")
